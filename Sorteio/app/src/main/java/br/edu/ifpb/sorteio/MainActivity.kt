...
import br.edu.ifpb.sorteio.R
import br.edu.ifpb.sorteio.repositorio.Cadastro
...
class MainActivity : AppCompatActivity() {
    ...
    fun sortear(){
        ...
        if (texto == null){
            Toast.makeText(this, "Cadastro está vazio, insira palavras!", Toast.LENGTH_SHORT).show()
        }else{
